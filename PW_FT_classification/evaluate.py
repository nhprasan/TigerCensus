...
def main(
        ...
        gpus:str='0', 
        logger_type:str='csv',
        evaluate:str='./weights/Crop/Plain/Crop_res50_plain_082723-0-epoch=14-valid_mac_acc=91.38.ckpt',
        np_threads:str='32',
        session:int=0,
        seed:int=0,
        dev:bool=False,
        val:bool=False, # If True, run validation; if False, run on test set.
        predict:bool=False,
        predict_root:str=""
    ):
    """
